...
- создать минимальную чистую схему Supabase для MPMF 1.0-данных;
...
- восстановление всех форм и всех действий MPMF 1.0 сразу;
...
- следующая ветка `feat/admin-crud-foundation` создана от актуального `main`.
